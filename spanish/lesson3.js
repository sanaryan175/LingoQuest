document.addEventListener("DOMContentLoaded", function () {
  const questions = [
    {
      question: "What is 'Father' in Spanish?",
      options: ["Madre", "Padre", "Hermano", "Abuelo"],
      answer: "Padre",
      explanation: "'Padre' means Father.",
    },
    {
      question: "Translate 'Mother' into Spanish.",
      options: ["Tía", "Abuela", "Madre", "Hermana"],
      answer: "Madre",
      explanation: "'Madre' means Mother.",
    },
    {
      question: "What does 'Hermano' mean?",
      options: ["Primo", "Sister", "Brother", "Tío"],
      answer: "Brother",
      explanation: "'Hermano' means Brother.",
    },
    {
      question: "What is 'Sister' in Spanish?",
      options: ["Hija", "Hermana", "Sobrina", "Abuela"],
      answer: "Hermana",
      explanation: "'Hermana' means Sister.",
    },
    {
      question: "What is 'Abuela' in English?",
      options: ["Uncle", "Grandmother", "Cousin", "Niece"],
      answer: "Grandmother",
      explanation: "'Abuela' means Grandmother.",
    },
    {
      question: "What is 'Tío' in English?",
      options: ["Uncle", "Aunt", "Nephew", "Brother"],
      answer: "Uncle",
      explanation: "'Tío' means Uncle.",
    },
  ];
 
  let xp = parseInt(localStorage.getItem(`xp_lesson3_spanish`)) || 0;
  let currentQuestion = parseInt(localStorage.getItem(`currentQuestion_lesson3_spanish`)) || 0;
  let lives = parseInt(localStorage.getItem(`lives_lesson3_spanish`)) || 3;
  let quizPassed = localStorage.getItem(`quizPassed_lesson3_spanish`) === "true";
  ...
  function saveProgress() {
    localStorage.setItem(`xp_lesson3_spanish`, xp);
    localStorage.setItem(`currentQuestion_lesson3_spanish`, currentQuestion);
    localStorage.setItem(`lives_lesson3_spanish`, lives);
  }
  ...
  function checkAnswer(selected, btn) {
    ...
    if (lives <= 0) {
      ...
      hideControlButtons();
      localStorage.setItem(`quizPassed_lesson3_spanish`, "true");
      setTimeout(() => {
...
function restartLesson() {
  const lessonId = "lesson3_spanish"; // Match this to the current lesson
  localStorage.removeItem(`xp_lesson3_spanish`);
  localStorage.removeItem(`currentQuestion_lesson3_spanish`);
  localStorage.removeItem(`lives_lesson3_spanish`);
  localStorage.removeItem(`quizPassed_lesson3_spanish`);
  location.reload();
}
